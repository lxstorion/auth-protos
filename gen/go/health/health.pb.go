...
const file_health_health_proto_rawDesc = "" +
	...
	"\x06Health\x12B\n" +
	"\x11CheckHealthStatus\x12\x15.health.HealthRequest\x1a\x16.health.HealthResponseB)Z'github.com/lxstorion/auth-protos;healthb\x06proto3"
...
var file_health_health_proto_depIdxs = []int32{
	0, // 0: health.Health.CheckHealthStatus:input_type -> health.HealthRequest
	1, // 1: health.Health.CheckHealthStatus:output_type -> health.HealthResponse

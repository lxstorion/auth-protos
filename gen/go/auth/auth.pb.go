...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\busername\x18\x02 \x01(\tR\busername2A\n" +
	"\x04Auth\x129\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponseB'Z%github.com/lxstorion/auth-protos;authb\x06proto3"
